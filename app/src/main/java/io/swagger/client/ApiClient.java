...
public class ApiClient {
    ...
    private String basePath = "https://localhost/ahoi/api/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("oauth2", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost/ahoi/api/v2
